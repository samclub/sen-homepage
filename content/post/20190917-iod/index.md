...
where $T$ is the monthly DMI, $T_\text{ENSO}\left(t\right)$ the monthly Niño-3.4 index, $\lambda\left(t\right)$ the damping rate of $T$, $\alpha\left(t\right)$ the ENSO forcing strength, $\xi\left(t\right)$ the stochastic forcing, and $\sigma_0$ the magnitude of stochastic forcing. The SST anomaly. Although the ENSO is a weak El Nino during October 2018 to June 2019 (See Figure S1b in [Zhao et al. 2019, GRL](https://doi.org/10.1029/2019GL084196)), the coupling strength is negative or close to zero over this period, therefore the 2018/2019 week El Nino event negatively contribute to the 2019 positive IOD event.
